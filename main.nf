...
exclude_intervals       = Channel.of([:]).mix(Channel.fromPath(params.exclude_intervals ? params.exclude_intervals : "", params.exclude_intervals_idx ? params.exclude_intervals_idx : "").collect())
