...
exclude_intervals       = Channel.fromPath([:], params.exclude_intervals ? params.exclude_intervals : "", params.exclude_intervals_tbi ? params.exclude_intervals_tbi : "").collect()
